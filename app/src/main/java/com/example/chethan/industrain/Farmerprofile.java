...
public class Farmerprofile extends AppCompatActivity  {
    ...
    @Override    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.selected=getIntent().getStringExtra("name");

        getSupportActionBar().setTitle(selected+"'s Products");
        ...
        mRecyclerView.addOnItemTouchListener(new RecyclerTouchListener(this, mRecyclerView,
                new RecyclerTouchListener.ClickListener() {
                    ...
                    public void onClick(View view, int position) {
                        ...
                        Toast.makeText(Farmerprofile.this, ""+uploadCurrent.getCropname(), Toast.LENGTH_SHORT).show();
    ...
    @Override    protected void onResume() {
        if (auth.getCurrentUser() == null) {
            startActivity(new Intent(Farmerprofile.this, Login.class).putExtra("mode1",1));
            finish();
        }
        super.onResume();
    }
    ...
    public void gett()
    {
        ...
        query.get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                ...
                try
                {
                    mAdapter=new sumnecheckadapter(Farmerprofile.this,mUploads);
