package com.example.chethan.industrain.phoneauthentication;
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                           ...
                           // Intent intent = new Intent(verifyphone.this, ProfileActivity.class);
                            ...
                            startActivity(new Intent(verifyphone.this,usermai.class));
                            finish();

                            //startActivity(intent);

                        } else {
                            Toast.makeText(verifyphone.this, "Phone number Addition failed! credential is already present",
