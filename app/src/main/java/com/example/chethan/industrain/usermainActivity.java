...
public class usermainActivity extends AppCompatActivity  {
    ...
    @Override    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(cropsearch);
        ...
        mRecyclerView.addOnItemTouchListener(new RecyclerTouchListener(this, mRecyclerView,
                new RecyclerTouchListener.ClickListener() {
                    ...
                    public void onClick(View view, int position) {
                        ...
                        Toast.makeText(usermainActivity.this, ""+uploadCurrent.getCropname(), Toast.LENGTH_SHORT).show();
    ...
    @Override    protected void onResume() {
        if (auth.getCurrentUser() == null) {
            startActivity(new Intent(usermainActivity.this, Login.class).putExtra("mode1",1));
            finish();
        }
        super.onResume();
    }
    ...
    public void gett()
    {
        ...
        query=FirebaseFirestore.getInstance().collection("users")
                ...
                .whereEqualTo("cropname",cropsearch.toString().trim())
        ...
        query.get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                ...
                try
                {
                    mAdapter=new sumnecheckadapter(usermainActivity.this,mUploads);
